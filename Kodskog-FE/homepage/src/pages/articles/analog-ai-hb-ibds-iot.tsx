...
const ArticleContent = () => {
  //pdf
  const file =
    "https://elasticbeanstalk-eu-north-1-102471047009.s3.eu-north-1.amazonaws.com/public/assets/articles/Literature Review - Enhancing IoT Security with Analog AI-Based Host-Based Intrusion Detection and Prevention Systems.pdf";
      ...
      {!isSmallScreen && (
        <div className="w-screen lg:h-[20vh] md:h-[30vh] h-[10vh] relative">
          ...
          <img
            ...
            src="https://elasticbeanstalk-eu-north-1-102471047009.s3.eu-north-1.amazonaws.com/public/assets/projects/Lines.png"
            alt="/"
          />
