...
const ArticleContent = () => {
  //pdf
  const file ="http://elasticbeanstalk-eu-north-1-102471047009.s3-website.eu-north-1.amazonaws.com/public/assets/articles/Efficiency in Code Clone Detection - A Comparative Analysis of JavaScript and Clojure.pdf";
  ...
  const downloadPDF = () => {
    ...
    link.href = file;
    link.download = "Efficiency in Code Clone Detection - A Comparative Analysis of JavaScript and Clojure.pdf"; // Set a filename for download
