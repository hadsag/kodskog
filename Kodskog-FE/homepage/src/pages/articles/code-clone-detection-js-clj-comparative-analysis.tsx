...
const ArticleContent = () => {
  //pdf
  const file ="https://elasticbeanstalk-eu-north-1-102471047009.s3.eu-north-1.amazonaws.com/public/assets/articles/Efficiency in Code Clone Detection - A Comparative Analysis of JavaScript and Clojure.pdf";
