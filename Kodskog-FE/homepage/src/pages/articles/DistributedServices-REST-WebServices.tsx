...
const ArticleContent = () => {
  //pdf
  const file ="https://elasticbeanstalk-eu-north-1-102471047009.s3.eu-north-1.amazonaws.com/public/assets/articles/Introduction to Distributed Services REST and Web Services.pdf";
