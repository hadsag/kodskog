...
const ArticleContent = () => {
  //pdf
  const file ="http://elasticbeanstalk-eu-north-1-102471047009.s3-website.eu-north-1.amazonaws.com/public/assets/articles/Introduction to Distributed Services REST and Web Services.pdf";
