...
const ArticleContent = () => {
  //pdf
  const file = "https://elasticbeanstalk-eu-north-1-102471047009.s3.eu-north-1.amazonaws.com/public/assets/articles/Optimizing Fast Food Image - A Comparative Study of VGG, ResNet, and Additional CNN Architectures in Pre-Trained Models.pdf";  const [numPages, setNumPages] = React.useState(0);
