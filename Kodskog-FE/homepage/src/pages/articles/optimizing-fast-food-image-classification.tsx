...
const ArticleContent = () => {
  //pdf
  const file = "/assets/articles/Optimizing Fast Food Image - A Comparative Study of VGG, ResNet, and Additional CNN Architectures in Pre-Trained Models.pdf";  const [numPages, setNumPages] = React.useState(0);
