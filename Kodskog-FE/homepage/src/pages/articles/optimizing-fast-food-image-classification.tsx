...
const ArticleContent = () => {
  //pdf
  const file = "http://elasticbeanstalk-eu-north-1-102471047009.s3-website.eu-north-1.amazonaws.com/public/assets/articles/Optimizing Fast Food Image - A Comparative Study of VGG, ResNet, and Additional CNN Architectures in Pre-Trained Models.pdf";  const [numPages, setNumPages] = React.useState(0);
  ...
  const downloadPDF = () => {
    ...
    link.href = file;
    link.download ="Optimizing Fast Food Image - A Comparative Study of VGG, ResNet, and Additional CNN Architectures in Pre-Trained Models"
